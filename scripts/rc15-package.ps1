...
& "$PSScriptRoot\scope-authority.ps1" -WriteReport | Out-Host
& "$PSScriptRoot\scope-preflight.ps1" -RequiresLiveRuntime -WriteReport | Out-Host

$Zip = "C:\AIOS\aios-codex-unlimited-enterprise-v2-RC15.zip"
$StagingRoot = Join-Path $ReleaseDir "zip-staging-rc15"
