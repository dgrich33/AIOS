...
$Zip = "C:\AIOS\aios-codex-unlimited-enterprise-v2-RC10.zip"
$StagingRoot = Join-Path $ReleaseDir "zip-staging-rc10"
...
Get-ChildItem -LiteralPath $Root -Recurse -File -Force | Where-Object {
  ...
  -not (
    ...
    $parts -contains "zip-staging-rc6" -or
    $parts -contains "zip-staging-rc7" -or
    $parts -contains "zip-staging-rc8" -or
    $parts -contains "zip-staging-rc9" -or
    $parts -contains "zip-staging-rc10" -or
